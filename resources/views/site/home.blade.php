	...
	<div class="row">
		<div class="col s12 center-align">
			<h1>
				...
				<span> é um excelente sistema para controle financeiro!</span>
			</h1>
		</div>
	</div>
	<div class="row">
		<div class="col s12">
			<div class="row card zdepth-5">
				...
				<div class="card-action white center-align">
					<a href="{{route('site.subscriptions.create')}}" class="btn btn-large waves-effect waves-light blue-grey darken-2">Contratar</a>
				</div>
			</div>
		</div>
	</div>
